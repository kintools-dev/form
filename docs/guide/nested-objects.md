---
description: "How a nested object becomes its own FieldApi with a lazy child registry: resolving the intermediate field first, path collisions, and aggregated state."
---
