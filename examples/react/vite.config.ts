...
// sees an edit to core/react/... again. Standalone (no Deno) keeps the
...
const workspaceAlias = {
  ...
  "@kintools/form-devtools-react": src("../../devtools-react/index.ts"),
  "@kintools/form-react": src("../../react/index.ts"),
